export default function Footer() {
  return (
    <footer id="contact" className="bg-slate-900/70 border-t border-slate-700/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 section-fade-in">
        ...
        <div className="flex justify-center items-center space-x-6">
          {/* Email */}
          <a href="mailto:kappalaharshith@gmail.com" className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">
          ...
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/k-harshit-109a07284/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">
          ...
          {/* GitHub */}
          <a href="https://github.com/karash10" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 transition-colors duration-300">
        ...
        <div className="text-center text-slate-500 mt-10 text-sm">
          {/* The React way to get the current year! */}
          &copy; {new Date().getFullYear()} K Harshit. All rights reserved.
        </div>
      </div>
    </footer>
  );
